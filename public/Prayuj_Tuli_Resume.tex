    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemExperience
          {Conducted biweekly office hours to assist students in learning course content.}
        \resumeItemExperience
          {Involved in grading student coursework such as exams and projects.}
        \resumeItemExperience
          {Worked with professors to automate grading workflow using the Google Sheets and Canvas APIs.}
        \resumeItemListEnd
